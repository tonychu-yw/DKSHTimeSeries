...
### Preface
This repo contains the term project for STAT 519 - Time Series Analysis at UW, including both the code (code.Rmd) and the final report (README.md). Please note that some functions/algorithms used in this project are imported from the website of Professor Donald B. Percival.
